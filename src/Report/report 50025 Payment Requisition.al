report 50025 "Payment Requisition"
{
    Caption = 'Payment Requisition';
    RDLCLayout = './src/Report/rdl/Payment Requisition.rdl';
    ...
    dataset
    {
        dataitem("Payment Requisition Header"; "Payment Requisition Header")
        {
            ...
            column(senderJobTitle; senderJobTitle)
            {

            }
            column(senderApproverDate; senderApproverDate)
            {
            ...
            begin
                ...
                if ApprovalEntry.FindSet() then
                    repeat
                        if ApprovalEntry."Sender ID" = ApprovalEntry."Approver ID" then begin
                            Employee.SetRange(Employee."User ID", ApprovalEntry."Sender ID");
                            if Employee.FindFirst() then begin
                                senderName := Employee.FullName();
                                senderJobTitle := Employee."Job Title";
                                senderApproverDate := ApprovalEntry."Last Date-Time Modified";
                            end;
                        end;
                ...
                // ReqArchive.Reset();
                // ReqArchive.SetRange(ReqArchive."No.", "Payment Requisition Header"."Request No.");
    ...
    var
        senderName: Text[100];
        senderJobTitle: Text[100];
        senderApproverDate: DateTime;
        grantsName: Text[500];
        GrantsDate: DateTime;
