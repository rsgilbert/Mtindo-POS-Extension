report 50027 "Payment Voucher Archive"
{
    Caption = 'Payment Voucher';
    RDLCLayout = './src/Report/rdl/Payment Voucher.rdl';
    ...
    dataset
    {
        dataitem("Payment Req. Header Archive"; "Payment Req. Header Archive")
        {
            ...
            dataitem("Payment Req Line Archive"; "Payment Req Line Archive")
            {
                ...
                DataItemTableView = SORTING("Document Type", "Archive No", "WorkPlan No", "Budget Code", "Payee Type", "Line No");
                ...
                column(Amount; "Amount Paid")
                {

                }
                column(Amount_To_Pay__LCY_; "Amount Paid (LCY)")
                {
