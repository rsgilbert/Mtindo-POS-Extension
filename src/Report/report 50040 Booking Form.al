report 50040 "Booking Form"
{
    Caption = 'Travel Request Form';
    RDLCLayout = './src/Report/rdl/Booking Form.rdl';
    ...
    dataset
    {
        dataitem("Payment Requisition Header"; "Payment Requisition Header")
        {
            ...
            column(Travellors_Names; "Travellors Names")
            {
            ...
            column(Expected_Check_in_Dates; "Expected Check in Dates")
            {

            }
            column(Expected_Check_Out_Dates; "Expected Check Out Dates")
            {

            }
            column(Budget_Name; "Budget Code")
            {

            }
            column(Destination_Address; "Destination Address")
            {
            ...
            dataitem("Payment Requisition Line"; "Payment Requisition Line")
            {
                ...
                column(Travel_Expense_Type; "Travel Expense Type") { }
                column(Rate; Rate)
                {
            ...
            begin
                ...
                if "Currency Code" = '' then
                    "Currency Code" := GeneralLedSetup."LCY Code";
    ...
    var
        ...
        JobTitle4: Text[100];
        JobTitle5: Text[100];
        Title: label 'Hotel Booking Form';
